...
public class S3CreateTaskConfigurator extends AbstractTaskConfigurator {
    ...
    public void populateContextForEdit(@NotNull final Map<String, Object> context,
        ...
        String region = taskDefinition.getConfiguration().get(AWS_REGION);
        if (!StringUtils.isEmpty(region)) {
            context.put(AWS_REGION, taskDefinition.getConfiguration().get(AWS_REGION));
        } else {
            context.put(AWS_REGION, DEFAULT_REGION);
        }
    }
}
